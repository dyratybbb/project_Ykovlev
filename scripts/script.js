...
document.querySelector('.contact-form').addEventListener('submit', function(event) {
    ...
    const email = document.querySelector('input[placeholder="Ваш email"]').value;
    const subject = document.querySelector('input[placeholder="Тема"]').value;
    const message = document.querySelector('textarea[placeholder="Ваше сообщение"]').value;
    ...
    alert('Ваше сообщение отправлено!'); // Уведомление об успешной отправке
});
window.addEventListener('load', function() {
    const savedData = JSON.parse(localStorage.getItem('contactForm'));
    if (savedData) {
        document.querySelector('input[placeholder="Ваше имя"]').value = savedData.name || '';
        document.querySelector('input[placeholder="Ваш email"]').value = savedData.email || '';
        document.querySelector('input[placeholder="Тема"]').value = savedData.subject || '';
        document.querySelector('textarea[placeholder="Ваше сообщение"]').value = savedData.message || '';
    }
});
